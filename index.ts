 ...
 *   start  — create a run (preflight checks), repin gpt-5.6-sol, queue the
 *            brainstorm continuation.
 *   status — print the compact run summary.
 *   pause  — checkpoint Paused; keep state; suppress prompts.
 *   resume — repin gpt-5.6-sol, continue at pending gate.
 *   off    — suppress prompts BUT retain the checkpoint (deleting a run is a

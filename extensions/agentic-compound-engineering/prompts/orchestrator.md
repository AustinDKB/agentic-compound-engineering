...
On completion the extension releases the MoA suspension token and restores the
user's prior MoA preference. `off` suppresses prompts and releases the token but
